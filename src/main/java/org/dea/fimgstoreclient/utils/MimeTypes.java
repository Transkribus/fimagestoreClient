...
public class MimeTypes {
	...
	public static final String MIME_IMAGE_JPEG2000 = "image/jpeg2";
	...
	static {
		mimeTypeMapping = new HashMap<String, String>(200) {
...

			{
				...
				put1("jp2", MIME_IMAGE_JPEG2000);
				put1("j2k", MIME_IMAGE_JPEG2000);
				put1("jpf", MIME_IMAGE_JPEG2000);
				put1("jpg2", MIME_IMAGE_JPEG2000);
